...
void i2c::init() {
	...
	// SERCOM setup
	SERCOM_REGS->I2CM.SERCOM_BAUD = SERCOM_I2CM_BAUD_BAUD(59);  // 400KHz
	SERCOM_REGS->I2CM.SERCOM_CTRLA = SERCOM_I2CM_CTRLA_LOWTOUTEN(1) | SERCOM_I2CS_CTRLA_RUNSTDBY(1)
	                               | SERCOM_I2CM_CTRLA_SPEED_STANDARD_AND_FAST_MODE | SERCOM_I2CM_CTRLA_PINOUT(0)
