...
static void initSERCOM(sercom_registers_t* regs) {
	...
	regs->USART_INT.SERCOM_CTRLA =
	    ...
	    | SERCOM_USART_INT_CTRLA_FORM_USART_FRAME_WITH_PARITY | SERCOM_USART_INT_CTRLA_RXPO_PAD2
	    | SERCOM_USART_INT_CTRLA_TXPO_PAD1 | SERCOM_USART_INT_CTRLA_MODE_USART_INT_CLK | SERCOM_USART_INT_CTRLA_ENABLE(1);
