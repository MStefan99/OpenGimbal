...
void buttons::init() {
	...
	PORT_REGS->GROUP[0].PORT_WRCONFIG = PORT_WRCONFIG_PINMASK(0x1 << 8u | 0x1 << 9u) | PORT_WRCONFIG_PMUXEN(1)
	                                  | PORT_WRCONFIG_INEN(1) | PORT_WRCONFIG_PULLEN(1)
	                                  | PORT_WRCONFIG_PMUX(MUX_PA24A_EIC_EXTINT4) | PORT_WRCONFIG_WRPMUX(1)
	...
	EIC_REGS->EIC_INTENSET = EIC_INTENSET_EXTINT4(1) | EIC_INTENSET_EXTINT5(1);
	EIC_REGS->EIC_WAKEUP = EIC_WAKEUP_WAKEUPEN4(1) | EIC_WAKEUP_WAKEUPEN5(1);
	EIC_REGS->EIC_CONFIG[0] = EIC_CONFIG_SENSE4_BOTH | EIC_CONFIG_SENSE5_BOTH;
